...
const CustomerEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'currentPendingAmount': PropertySchema(
      id: 2,
      name: r'currentPendingAmount',
...
void _customerEntitySerialize(
  ...
  writer.writeDouble(offsets[2], object.currentPendingAmount);
  ...
  writer.writeDouble(offsets[9], object.totalPurchases);
...
CustomerEntity _customerEntityDeserialize(
  ...
  final object = CustomerEntity(
    ...
    currentPendingAmount: reader.readDoubleOrNull(offsets[2]) ?? 0.0,
    ...
    totalPurchases: reader.readDoubleOrNull(offsets[9]) ?? 0.0,
...
extension CustomerEntityByIndex on IsarCollection<CustomerEntity> {
  Future<CustomerEntity?> getByMobile(String mobile) {
    return getByIndex(r'mobile', [mobile]);
  }

  CustomerEntity? getByMobileSync(String mobile) {
  ...
  Future<List<CustomerEntity?>> getAllByMobile(List<String> mobileValues) {
    final values = mobileValues.map((e) => [e]).toList();
    return getAllByIndex(r'mobile', values);
  }

  List<CustomerEntity?> getAllByMobileSync(List<String> mobileValues) {
    final values = mobileValues.map((e) => [e]).toList();
  ...
  Future<Id> putByMobile(CustomerEntity object) {
    return putByIndex(r'mobile', object);
  }

  Id putByMobileSync(CustomerEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'mobile', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByMobile(List<CustomerEntity> objects) {
    return putAllByIndex(r'mobile', objects);
  }

  List<Id> putAllByMobileSync(
    List<CustomerEntity> objects, {
    bool saveLinks = true,
  }) {
...
extension CustomerEntityQueryWhereSort
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterWhere> anyIsSynced() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterWhere> anyIsDeleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterWhere> anyUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension CustomerEntityQueryWhere
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterWhereClause> mobileEqualTo(
    String mobile,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.equalTo(indexName: r'mobile', value: [mobile]),
      );
    });
  }
...
extension CustomerEntityQueryFilter
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterFilterCondition>
  currentPendingAmountEqualTo(double value, {double epsilon = Query.epsilon}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'currentPendingAmount',
          value: value,
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterFilterCondition>
  currentPendingAmountGreaterThan(
    double value, {
    bool include = false,
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterFilterCondition>
  totalPurchasesEqualTo(double value, {double epsilon = Query.epsilon}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
...
extension CustomerEntityQuerySortBy
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy>
  sortByCurrentPendingAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentPendingAmount', Sort.asc);
    });
  }
  ...
  sortByCurrentPendingAmountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentPendingAmount', Sort.desc);
    });
  }
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy> sortByIsDeleted() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy> sortByIsSynced() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy> sortByMobile() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerEntityQuerySortThenBy
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy>
  thenByCurrentPendingAmountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentPendingAmount', Sort.desc);
    });
  }
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy> thenByIsDeleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeleted', Sort.asc);
    });
  }
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy> thenByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSynced', Sort.asc);
    });
  }
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QAfterSortBy> thenByMobile() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mobile', Sort.asc);
    });
  }
...
extension CustomerEntityQueryWhereDistinct
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QDistinct>
  distinctByCurrentPendingAmount() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'currentPendingAmount');
    });
  }
  ...
  QueryBuilder<CustomerEntity, CustomerEntity, QDistinct> distinctByIsSynced() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isSynced');
    });
  }

  QueryBuilder<CustomerEntity, CustomerEntity, QDistinct> distinctByMobile({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerEntityQueryProperty
  ...
  QueryBuilder<CustomerEntity, double, QQueryOperations>
  currentPendingAmountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currentPendingAmount');
    });
  }
  ...
  QueryBuilder<CustomerEntity, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDeleted');
    });
  }

  QueryBuilder<CustomerEntity, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isSynced');
    });
  }

  QueryBuilder<CustomerEntity, String, QQueryOperations> mobileProperty() {
    return QueryBuilder.apply(this, (query) {
