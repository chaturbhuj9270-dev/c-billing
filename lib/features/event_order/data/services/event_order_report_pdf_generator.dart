...
class EventOrderReportPdfGenerator {
            ...
            children: [
              ...
              pw.Container(
                ...
                child: pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text('Total: ${orders.length}',
                        style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold)),
                    pw.Text('Confirmed: $confirmedCount',
                        style: const pw.TextStyle(fontSize: 9)),
                    pw.Text('Pending: $pendingCount',
                        style: const pw.TextStyle(fontSize: 9)),
                    pw.Text('Delivered: $deliveredCount',
                        style: const pw.TextStyle(fontSize: 9)),
                    pw.Text('Total Amt: Rs. ${totalAmount.toStringAsFixed(0)}',
                        style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold)),
                    pw.Text('Advance: Rs. ${totalAdvance.toStringAsFixed(0)}',
                        style: const pw.TextStyle(fontSize: 9)),
                    pw.Text('Due: Rs. ${totalDue.toStringAsFixed(0)}',
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text('Generated by C-Billing',
  ...
  /// Print the PDF.
  static Future<void> printReport(Uint8List pdfBytes, {bool isEvent = true}) async {
  ...
  static Future<void> shareReport(Uint8List pdfBytes, {bool isEvent = true}) async {
  ...
  static Future<File> saveToFile(Uint8List pdfBytes, {bool isEvent = true}) async {
    final tempDir = await getTemporaryDirectory();
    final timestamp = DateFormat('yyyyMMdd_HHmmss').format(DateTime.now());
    final name = isEvent ? 'event_report' : 'order_report';
